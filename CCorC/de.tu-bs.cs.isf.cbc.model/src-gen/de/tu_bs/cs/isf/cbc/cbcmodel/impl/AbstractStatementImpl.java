...
public class AbstractStatementImpl extends MinimalEObjectImpl.Container implements AbstractStatement {
	 ...
	 * @ordered
	 */
	protected static final Confidentiality CONTEXT_EDEFAULT = Confidentiality.LOW;
	 ...
	 * @ordered
	 */
	protected Confidentiality context = CONTEXT_EDEFAULT;
	 ...
	 * @generated
	 */
	public Confidentiality getContext() {
		return context;
	}
	 ...
	 * @generated
	 */
	public void setContext(Confidentiality newContext) {
		Confidentiality oldContext = context;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CbcmodelPackage.ABSTRACT_STATEMENT__COMMENT:
				...
				return;
			case CbcmodelPackage.ABSTRACT_STATEMENT__CONTEXT:
				setContext((Confidentiality)newValue);
				return;
		}
