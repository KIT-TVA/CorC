	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractStatement_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractStatement_context_feature", "_UI_AbstractStatement_type"),
				 CbcmodelPackage.Literals.ABSTRACT_STATEMENT__CONTEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
