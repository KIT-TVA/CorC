...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.taxonomy.model.taxonomy.Taxonomy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaxonomyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Taxonomy_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Taxonomy_name_feature", "_UI_Taxonomy_type"),
				 TaxonomyPackage.Literals.TAXONOMY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaxonomyPackage.Literals.TAXONOMY__ALGORITHMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TaxonomyPackage.Literals.TAXONOMY__ALGORITHMS,
				 TaxonomyFactory.eINSTANCE.createAlgorithm()));
	}
