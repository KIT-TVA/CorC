...
/**
 * first page from the wizard lets the user choose a name for the path where a
 * new project will be created in this project the examples that where selected
 * will be pasted
 */
public class CorCProjectNamePage extends WizardPage implements Listener {
	...
	public CorCProjectNamePage() {
		...
		setDescription(
				"this wizard will create a new project with the selected name, that will contain the selected CorC examples");
	}
