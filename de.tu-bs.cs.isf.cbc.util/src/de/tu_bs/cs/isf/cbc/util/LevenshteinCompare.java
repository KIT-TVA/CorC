...
public class LevenshteinCompare {
	...
	/**
	 * This method returns the Levenshtein Distance of two Strings. The Levenshtein
	 * Distance shows how many of the characters of String number two need to be
	 * changed in order to get String one.
	 * 
	 * @param s1
	 *            String number one
	 * @param s2
	 *            String number two, which is compared to String number two
