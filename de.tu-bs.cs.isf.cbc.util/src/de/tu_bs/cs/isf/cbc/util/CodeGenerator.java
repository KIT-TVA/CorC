...
public class CodeGenerator {
	...
	private String constructCodeBlockOfChildStatement(AbstractStatement refinement) throws TestAndAssertionGeneratorException {
	...
	private  String constructSmallRepetition(SmallRepetitionStatement statement) throws TestAndAssertionGeneratorException {
		StringBuffer buffer = new StringBuffer();
	...
	public String genCode(Diagram diagram, boolean onlyMethod) throws TestAndAssertionGeneratorException, SettingsException {
		...
		return generateCode(projectPath, formula, globalConditions, renaming, localVariables, returnVariable, signatureString, globalVariables, vars.getFields().stream().map(f -> f.getType() + " " + f.getName()).toList(), onlyMethod);
	}
	 ...
	 */
	private String generateCode(URI projectPath, CbCFormula formula, GlobalConditions globalConditions, Renaming renaming, LinkedList<String> vars, JavaVariable returnVar, String signatureString, String globalVariables, List<String> gVars, boolean onlyMethod) throws TestAndAssertionGeneratorException, SettingsException {	
		String existingCode = "";
