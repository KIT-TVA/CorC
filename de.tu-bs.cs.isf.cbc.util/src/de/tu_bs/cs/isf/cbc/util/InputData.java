...
public class InputData {
    ...
    /**
     * Variable *rep* represent the last representation of a class implementing
     * this. This means if there was a call to *getRandomValue()* at the latest,
     * then it will be just the string representation of that value. If the last
     * call was *getArrayRep()* then it will be a string representation of that
     * array.
     */
    private String rep;
	...
	brackets = brackets.substring(0, start + 1) + this.values.length
		+ brackets.substring(start + 1, brackets.length());
