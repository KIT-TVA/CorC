...
public class ProofPath {
	 ...
	 * @param map			the {@link SequentFormula} => {@link CEType} mapping for the {@link Node} provided
	...
	/**
	 * Updates the {@link SequentFormula} => {@link CEType} mapping a single time for the {@link Node}s provided.
	 * 
	 ...
	 * @param workingMap	the current {@link SequentFormula} => {@link CEType} mapping
	 */
