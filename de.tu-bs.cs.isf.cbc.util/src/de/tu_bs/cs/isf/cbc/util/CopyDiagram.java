...
public class CopyDiagram {
	...
	private void copyFormula(CbCFormula formula) {
		...
		if (formula.getMethodObj() != null) {
			newFormula.setMethodName(formula.getMethodObj().getSignature().replaceFirst(formula.getName(), name)); // TODO:
																													// Find
																													// better
																													// way
																													// of
	...
	private void copyVars(JavaVariables vars, CbCFormula formula) {
		...
		// Note: Fields and Params will not be copied since they should be set by the
		// class.
