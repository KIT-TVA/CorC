...
public class CbcmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected CbcmodelSwitch<Adapter> modelSwitch =
		new CbcmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMethodLink(MethodLink object) {
				return createMethodLinkAdapter();
			}
			@Override
			public Adapter caseIFbCSpecification(IFbCSpecification object) {
				return createIFbCSpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink <em>Method Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMethodLinkAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.cbc.cbcmodel.IFbCSpecification <em>IFb CSpecification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIFbCSpecificationAdapter() {
		return null;
	}
