...
public class CbcmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CbcmodelPackage.METHOD_LINK: {
				MethodLink methodLink = (MethodLink)theEObject;
				T result = caseMethodLink(methodLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CbcmodelPackage.IFB_CSPECIFICATION: {
				IFbCSpecification iFbCSpecification = (IFbCSpecification)theEObject;
				T result = caseIFbCSpecification(iFbCSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Method Link</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Method Link</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMethodLink(MethodLink object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>IFb CSpecification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IFb CSpecification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIFbCSpecification(IFbCSpecification object) {
		return null;
	}
