...
public interface CbcmodelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CB_CFORMULA_FEATURE_COUNT = 8;
	 ...
	 * @ordered
	 */
	int CONDITION__AT_TYPES_TO_VARS_MAP = 2;
	 ...
	 * @ordered
	 */
	int CONDITION__CAPSULES_USED = 3;
	 ...
	 * @ordered
	 */
	int ABSTRACT_STATEMENT__TYPEABLE_RESULT = 8;

	/**
	 * The feature id for the '<em><b>Tyleable Text</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ABSTRACT_STATEMENT__TYLEABLE_TEXT = 9;
	 ...
	 * @ordered
	 */
	int ABSTRACT_STATEMENT_FEATURE_COUNT = 10;
	 ...
	 * @ordered
	 */
	int SKIP_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int COMPOSITION_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int SELECTION_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int REPETITION_STATEMENT__TYPEABLE_RESULT = ABSTRACT_STATEMENT__TYPEABLE_RESULT;
	 ...
	 * @ordered
	 */
	int REPETITION_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int METHOD_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int RETURN_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int COMPOSITION3_STATEMENT__TYPEABLE_RESULT = ABSTRACT_STATEMENT__TYPEABLE_RESULT;
	 ...
	 * @ordered
	 */
	int COMPOSITION3_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int SMALL_REPETITION_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	 ...
	 * @ordered
	 */
	int JAVA_VARIABLE_FEATURE_COUNT = 4;
	 ...
	 * @ordered
	 */
	int STRENGTH_WEAK_STATEMENT__TYLEABLE_TEXT = ABSTRACT_STATEMENT__TYLEABLE_TEXT;
	...
	/**
	 * The meta object id for the '{@link de.tu_bs.cs.isf.cbc.cbcmodel.impl.MethodLinkImpl <em>Method Link</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.MethodLinkImpl
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.CbcmodelPackageImpl#getMethodLink()
	 * @generated
	 */
	int METHOD_LINK = 24;
	 ...
	 * @ordered
	 */
	int METHOD_LINK__METHOD_SIGNATURE = 1;

	/**
	 * The number of structural features of the '<em>Method Link</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int METHOD_LINK_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>Method Link</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int METHOD_LINK_OPERATION_COUNT = 0;

	/**
	 * The meta object id for the '{@link de.tu_bs.cs.isf.cbc.cbcmodel.impl.IFbCSpecificationImpl <em>IFb CSpecification</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.IFbCSpecificationImpl
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.CbcmodelPackageImpl#getIFbCSpecification()
	 * @generated
	 */
	int IFB_CSPECIFICATION = 25;
	 ...
	 * @ordered
	 */
	int IFB_CSPECIFICATION__SPECIFICATION = 0;

	/**
	 * The number of structural features of the '<em>IFb CSpecification</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IFB_CSPECIFICATION_FEATURE_COUNT = 1;

	/**
	 * The number of operations of the '<em>IFb CSpecification</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IFB_CSPECIFICATION_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the attribute '{@link de.tu_bs.cs.isf.cbc.cbcmodel.AbstractStatement#getTyleableText <em>Tyleable Text</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Tyleable Text</em>'.
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.AbstractStatement#getTyleableText()
	 * @see #getAbstractStatement()
	 * @generated
	 */
	EAttribute getAbstractStatement_TyleableText();
	...
	/**
	 * Returns the meta object for class '{@link de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink <em>Method Link</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Method Link</em>'.
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink
	 * @generated
	 */
	EClass getMethodLink();

	/**
	 * Returns the meta object for the attribute '{@link de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink#getClassName <em>Class Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Class Name</em>'.
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink#getClassName()
	 * @see #getMethodLink()
	 * @generated
	 */
	EAttribute getMethodLink_ClassName();

	/**
	 * Returns the meta object for the attribute '{@link de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink#getMethodSignature <em>Method Signature</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Method Signature</em>'.
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.MethodLink#getMethodSignature()
	 * @see #getMethodLink()
	 * @generated
	 */
	EAttribute getMethodLink_MethodSignature();

	/**
	 * Returns the meta object for class '{@link de.tu_bs.cs.isf.cbc.cbcmodel.IFbCSpecification <em>IFb CSpecification</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>IFb CSpecification</em>'.
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.IFbCSpecification
	 * @generated
	 */
	EClass getIFbCSpecification();

	/**
	 * Returns the meta object for the attribute '{@link de.tu_bs.cs.isf.cbc.cbcmodel.IFbCSpecification#getSpecification <em>Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Specification</em>'.
	 * @see de.tu_bs.cs.isf.cbc.cbcmodel.IFbCSpecification#getSpecification()
	 * @see #getIFbCSpecification()
	 * @generated
	 */
	EAttribute getIFbCSpecification_Specification();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Tyleable Text</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute ABSTRACT_STATEMENT__TYLEABLE_TEXT = eINSTANCE.getAbstractStatement_TyleableText();
		...
		/**
		 * The meta object literal for the '{@link de.tu_bs.cs.isf.cbc.cbcmodel.impl.MethodLinkImpl <em>Method Link</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.MethodLinkImpl
		 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.CbcmodelPackageImpl#getMethodLink()
		 * @generated
		 */
		EClass METHOD_LINK = eINSTANCE.getMethodLink();
		 ...
		 * @generated
		 */
		EAttribute METHOD_LINK__CLASS_NAME = eINSTANCE.getMethodLink_ClassName();
		 ...
		 * @generated
		 */
		EAttribute METHOD_LINK__METHOD_SIGNATURE = eINSTANCE.getMethodLink_MethodSignature();

		/**
		 * The meta object literal for the '{@link de.tu_bs.cs.isf.cbc.cbcmodel.impl.IFbCSpecificationImpl <em>IFb CSpecification</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.IFbCSpecificationImpl
		 * @see de.tu_bs.cs.isf.cbc.cbcmodel.impl.CbcmodelPackageImpl#getIFbCSpecification()
		 * @generated
		 */
		EClass IFB_CSPECIFICATION = eINSTANCE.getIFbCSpecification();
		 ...
		 * @generated
		 */
		EAttribute IFB_CSPECIFICATION__SPECIFICATION = eINSTANCE.getIFbCSpecification_Specification();
