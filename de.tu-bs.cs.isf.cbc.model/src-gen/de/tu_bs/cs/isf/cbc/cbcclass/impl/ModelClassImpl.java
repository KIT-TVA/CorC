 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getJavaClassURI <em>Java Class URI</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getClassInvariants <em>Class Invariants</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.impl.ModelClassImpl#getInheritsFrom <em>Inherits From</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelClassImpl extends MinimalEObjectImpl.Container implements ModelClass {
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentWithInverseEList<Method>(Method.class, this, CbcclassPackage.MODEL_CLASS__METHODS, CbcclassPackage.METHOD__PARENT_CLASS);
		}
		return methods;
	}
	...
	public void setPackage(String newPackage) {
		...
		package_ = newPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CbcclassPackage.MODEL_CLASS__PACKAGE, oldPackage, package_));
	}
	...
	public void setFeature(String newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CbcclassPackage.MODEL_CLASS__FEATURE, oldFeature, feature));
	}
	...
	public ModelClass getInheritsFrom() {
		if (inheritsFrom != null && inheritsFrom.eIsProxy()) {
			...
			if (inheritsFrom != oldInheritsFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CbcclassPackage.MODEL_CLASS__INHERITS_FROM, oldInheritsFrom, inheritsFrom));
			}
		}
		return inheritsFrom;
	}
	...
	public void setInheritsFrom(ModelClass newInheritsFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CbcclassPackage.MODEL_CLASS__INHERITS_FROM, oldInheritsFrom, inheritsFrom));
	}
