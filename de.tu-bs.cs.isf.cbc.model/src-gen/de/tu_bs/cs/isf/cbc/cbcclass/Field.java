 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.Field#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.Field#getType <em>Type</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.Field#getName <em>Name</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.Field#isIsStatic <em>Is Static</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.Field#isIsFinal <em>Is Final</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.cbc.cbcclass.Field#getDisplayedName <em>Displayed Name</em>}</li>
 * </ul>
 *
 * @see de.tu_bs.cs.isf.cbc.cbcclass.CbcclassPackage#getField()
 * @model
 * @generated
 */
