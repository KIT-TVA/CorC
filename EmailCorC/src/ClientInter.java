public interface ClientInter{
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Client createClientResultOld(String name) {
		Client result = null;
		result = new Client();
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Client createClientResult(String name) {
		Client result = null;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Client getClientById(int id) {
		Client result = null;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default int getId() {
		int result = 0;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default String getNameWithKeyword() {
		String result = null;
	...
	@*/
	public /*@helper@*/ default void outgoing(Client client, Email msg) {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default void resetClients() {
		int index = 0;
		index = 0;
	...
	@*/
	public /*@helper@*/ default void constructClient(int idx, String namex) {
		this.client.id = idx;
	...
	@*/
	public /*@helper@*/ default Client createClient(String name) {
		Client result = null;
		result = new Client();
		result.constructClient(Client.clientCounter++, name);
		Client.clients[result.getId()] = result;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Client getClientByAdress(String address) {
		int index = 0;
		Client result = null;
		index = 0;
		result = null;
