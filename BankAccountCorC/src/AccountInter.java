public interface  AccountInter {
	...
	public default int getBalance() {return 1;}
	public int setBalance(int balance);
	public default int getWithdraw() {return 1;}
	public int setWithdraw(int withdraw);
	public default int getInterest() {return 1;}
	public default boolean getLock() {return true;};
	...
	/*@
	 ...
	 @*/
	public /*@helper@*/ default boolean update(int x) {
	...
	/*@
	 ...
	 @*/
	public /*@helper@*/ default boolean undoUpdate(int x) {
		int newBalance = getBalance() - x;
		if (newBalance < getOVERDRAFT_LIMIT())
			return false;
		setBalance(newBalance);
	...
	@ assignable \nothing;
	@*/
	public /*@helper pure@*/ default int interestCalculate() {
		int result;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default int interestEstimated(int daysLeft) {
		int result;
	...
	/*@
	 ...
	 @*/
	public /*@helper@*/ default void lock() {
		setLock(true);
	}
	...
	/*@
	 ...
	 @ ensures !getLock() == true;
	 @*/
	public /*@helper@*/ default void unLock() {
		setLock(false);
	}
	...
	/*@
	 ...
	 @ assignable \nothing;
	 @*/
	public /*@helper@*/ default boolean isLocked() {
		return getLock();
	}
	...
	/*@
	  ...
	  @ assignable \nothing;
	 @*/
	public /*@helper@*/ default boolean lockBoth(AccountInter source, AccountInter destination) {
	...
	/*@ requires destination != null && source != null && source != destination;
	  ...
	  @ assignable \nothing;
	  @*/
	public /*@helper@*/ default boolean transfer(AccountInter source, AccountInter destination, int amount) {
		...
		@*/
		public /*@helper@*/ default boolean bankAccountUndoUpdate(int x) {
			int newBalance;
			boolean result;
		...
		@ ensures (\result == false ==> getBalance() == \old(getBalance())) && (\result == true ==> getBalance() == \old(getBalance()) + x);
		@*/
		public default boolean bankAccountUpdate(int x) {
			int newBalance;
			boolean result;
			result = false;
			newBalance = getBalance() + x;
		...
		@ assignable \nothing;
		@*/
		public default boolean creditAccountCredit(int amount) {
			boolean result;
		...
		@*/
		public default boolean dailyAccountUpdate(int x) {
			int newWithdraw;
			boolean tmp;
			boolean result;
			result = false;
		...
		@*/
		public default boolean transactionAccountLock(AccountInter source, AccountInter destination) {
			boolean result;
		...
		@ assignable \everything;
		@*/
		public default boolean transactionAccountTransfer2(AccountInter source, AccountInter destination, int amount) {
			boolean result;
			boolean tmp;
			boolean tmp2;
