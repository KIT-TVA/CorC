public class ComposedAccount {	/*@
	...
	public boolean update(int x) {
		...
		if (newBalance < getOVERDRAFT_LIMIT())return false;
	...
	@ assignable \nothing;
	@*/
	public int interestEstimated(int daysLeft) {
		int result;
	...
	/*@
	  ...
	  @ assignable \nothing;
	 @*/
	public boolean lockBoth(AccountInter source,AccountInter destination) {
	...
	/*@ requires destination != null && source != null && source != destination;
	  ...
	  @ assignable \nothing;
	  @*/
	public boolean transfer(AccountInter source,AccountInter destination,int amount) {
		...
		@*/
		public boolean bankAccountUndoUpdate(int x) {
		int newBalance;
		boolean result;
