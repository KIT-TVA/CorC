...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>statistics</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class statisticsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.statistics"));
				StatisticsRegistry root = statisticsFactory.eINSTANCE.createStatisticsRegistry();
