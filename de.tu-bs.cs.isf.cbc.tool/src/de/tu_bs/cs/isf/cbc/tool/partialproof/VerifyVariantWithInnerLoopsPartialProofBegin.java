...
public class VerifyVariantWithInnerLoopsPartialProofBegin extends MyAbstractAsynchronousCustomFeature {
	 ...
	 *            The FeatureProvider
	 */
	public VerifyVariantWithInnerLoopsPartialProofBegin(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify the variant (splitted) as partial proof (begin)";
	}
