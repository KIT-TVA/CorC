...
public class TestAndAssertionListener implements ITestListener {
	  ...
	  public TestAndAssertionListener(final URI projectPath, final String diagramName, final List<String> globalVars, final List<TestCaseData> inputDataTupels) {
		  this.projectPath = projectPath;
		  this.inputDataTupels = inputDataTupels;
		  this.globalVars = globalVars;
		  this.dataCollector = new DataCollector(projectPath, diagramName); 
	  }
	  ...
	  public void onTestSuccess(ITestResult result) {
		  ...
		  dataCollector.addTestCaseTime(testMethodName, testTime); 
	...
	public void onTestSkipped(ITestResult result) {
		  float testTime = (System.nanoTime() - testStartTime / 1000000);
		  dataCollector.addTestCaseTime(result.getName(), testTime); 
	}
