...
// /* (non-Javadoc)
// * @see
// org.eclipse.graphiti.features.custom.AbstractCustomFeature#canExecute(org.eclipse.graphiti.features.context.ICustomContext)
// */
// @Override
...
// layoutAlgorithm.applyLayout(entities, connections, 0,
// 0, ga.getWidth(), ga.getHeight(), false, false);
//
...
//
// /**
// * Used to keep track of the initial Connection locations for self
// connections<br/>
// * The self connections cannot be computed by the LayoutAlgorithmn but the
// Nodes will probably be moved<br/>
// * So we need to recompute the bend points locations based on the offset of
// the Anchor from the initial location
// *
// * @return a {@link Map} of initial {@link Anchor} location {@link Point} per
// {@link Connection}s
// */
...
//
// /**
// * Reposition the bendpoints based on the offset from the initial {@link
// Anchor} location to the new location
// *
// * @param selves The {@link Map} of initial {@link Anchor} location {@link
// Point} per {@link Connection}s
// */
...
//
// /**
// * Reposition the Graphiti {@link PictogramElement}s and {@link Connection}s
// based on the
...
// * @param connections
// */
// private void updateGraphCoordinates(LayoutEntity[] entities,
// LayoutRelationship[] connections) {
...
// // Using FreeFormConnections with BendPoints, we reset them to the Zest
// computed locations
...
// SimpleNode entity = new SimpleNode(shape, ga.getX(), ga.getY(),
...
//
// /**
// * @param map a {@link Map} of {@link SimpleNode} per {@link Shape} - used to
// link {@link SimpleRelationship} to source and target entities
// * @return the array of {@link LayoutRelationship}s to compute
// */
// private LayoutRelationship[] getConnectionEntities(Map<Shape, SimpleNode>
// map) {
...
// Shape source = (Shape) connection.getStart().getParent().eContainer();
...
// SimpleRelationship relationship = new SimpleRelationship(sourceEntity,
// targetEntity, (source != target));
...
// LayoutBendPoint bendPoint = new BendPoint(point.getX(), point.getY(),
// isControlPoint);
...
// });
// System.out.println("CompositeLayoutAlgorithm
...
//
// /**
// * A {@link org.eclipse.zest.layouts.exampleStructures.SimpleRelationship}
// subclass
