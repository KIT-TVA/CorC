 ...
 *
 */
public class AboveRepetitionFeature extends AbstractCustomFeature {
    
    /**
     * Constructor of the class
     * @param fp	The FeatureProvider
     */
    public AboveRepetitionFeature(IFeatureProvider fp) {
        super(fp);
    }
    
    @Override
    public String getName() {
        return "Repetition statement above";
    }
 
    @Override
    public String getDescription() {
        return "Generates a repetition statement above this statement.";
    }
    ...
    public void execute(ICustomContext context) {
        ...
        if (pes != null && pes.length == 1) {
            ...
            if (bo instanceof AbstractStatement) {
            	...
            	SmallRepetitionStatement newParent = (SmallRepetitionStatement) newParents[0];
            	...
            	Shape peNewParentStatement = (Shape) getFeatureProvider().getPictogramElementForBusinessObject(newParent.getLoopStatement());
    ...
    private ICreateFeature getCreateFeature(ICreateFeature[] features) {
    	for (ICreateFeature feature : features) {
    		if (feature.getCreateName().equals("RepetitionStatement")) {
    			return feature;
    		}
    	}
		return null;
