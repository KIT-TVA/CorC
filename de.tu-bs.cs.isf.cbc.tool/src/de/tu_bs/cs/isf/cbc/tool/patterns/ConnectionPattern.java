...
public class ConnectionPattern extends AbstractConnectionPattern {
	...
	public boolean canStartConnection(ICreateConnectionContext context) {
		...
		if (domainObject != null && (domainObject instanceof AbstractStatement)) {
			AbstractStatement statement = (AbstractStatement) domainObject;
			if (statement.getRefinement() != null) {
				return false;
			}
		}
		if (domainObject != null && (domainObject instanceof CbCFormula)) {
			CbCFormula formula = (CbCFormula) domainObject;
