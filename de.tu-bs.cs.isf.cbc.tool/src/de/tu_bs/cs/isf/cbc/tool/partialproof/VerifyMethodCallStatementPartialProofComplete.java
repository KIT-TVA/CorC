...
public class VerifyMethodCallStatementPartialProofComplete extends MyAbstractAsynchronousCustomFeature {
	 ...
	 */
	public VerifyMethodCallStatementPartialProofComplete(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify a method-call statement as partial proof (continue)";
	}
