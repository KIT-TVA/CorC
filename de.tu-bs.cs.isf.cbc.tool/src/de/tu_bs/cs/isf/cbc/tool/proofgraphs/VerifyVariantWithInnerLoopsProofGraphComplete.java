...
public class VerifyVariantWithInnerLoopsProofGraphComplete extends MyAbstractAsynchronousCustomFeature {
	 ...
	 *            The FeatureProvider
	 */
	public VerifyVariantWithInnerLoopsProofGraphComplete(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify the variant (splitted) as proof graph (continue)";
	}
