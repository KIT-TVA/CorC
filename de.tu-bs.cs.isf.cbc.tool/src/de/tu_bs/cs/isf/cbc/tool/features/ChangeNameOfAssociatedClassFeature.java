 ...
 *
 */
public class ChangeNameOfAssociatedClassFeature extends AbstractCustomFeature {
     ...
     */
    public ChangeNameOfAssociatedClassFeature(IFeatureProvider fp) {
        super(fp);
    }
 
    @Override
    public String getName() {
        return "Edit Name of Associated Class";
    }
 
    @Override
    public String getDescription() {
        return "Edit the Name of the Associated Class";
    }
    ...
    public void execute(ICustomContext context) {
        ...
        if (pes != null && pes.length == 1) {
            ...
            if (bo instanceof CbCFormula) {
                ...
                String currentName = formula.getClassName();
                // ask user for a new class name
                String newName = askString(getName(), getDescription(),
                        currentName);
                if (newName != null && !newName.equals(currentName)) {
            		this.hasDoneChanges = true;
                    formula.setClassName(newName);
