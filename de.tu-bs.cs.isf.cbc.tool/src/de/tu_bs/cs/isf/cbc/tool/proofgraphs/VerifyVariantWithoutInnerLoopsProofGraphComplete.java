...
public class VerifyVariantWithoutInnerLoopsProofGraphComplete extends MyAbstractAsynchronousCustomFeature {
	 ...
	 *            The FeatureProvider
	 */
	public VerifyVariantWithoutInnerLoopsProofGraphComplete(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify the variant without inner loops (splitted) as proof graph (continue)";
	}
