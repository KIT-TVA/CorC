...
public class VerifyOriginalCallStatementPartialProofComplete extends MyAbstractAsynchronousCustomFeature {
	 ...
	 */
	public VerifyOriginalCallStatementPartialProofComplete(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify an original-call statement as partial proof (continue)";
	}
