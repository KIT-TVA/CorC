...
public class StrengthWeakStatementPattern extends IdPattern implements IPattern {
	...
	protected boolean layout(IdLayoutContext context, String id) {
		...
		if (id.equals(ID_NAME_TEXT)) {
			...
			// Changes start
			// Graphiti.getGaService().setLocationAndSize(ga, mainRectangle.getWidth() - 20,
			// 10, 10, 10);
	...
	protected IReason updateNeeded(IdUpdateContext context, String id) {
		if (context.getGraphicsAlgorithm() instanceof MultiText
				&& context.getDomainObject() instanceof StrengthWeakStatement) {
	...
	protected boolean update(IdUpdateContext context, String id) {
		if (context.getGraphicsAlgorithm() instanceof MultiText
			...
			if (domainObject.isProven()
					&& ((childStatement != null && childStatement.isProven()) || childStatement == null)) {
	...
	public String getInitialValue(IDirectEditingContext context) {
		StrengthWeakStatement statement = (StrengthWeakStatement) getBusinessObjectForPictogramElement(
