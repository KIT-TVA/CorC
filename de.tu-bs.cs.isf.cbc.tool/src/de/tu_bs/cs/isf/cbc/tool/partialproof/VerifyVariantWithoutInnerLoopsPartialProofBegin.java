...
public class VerifyVariantWithoutInnerLoopsPartialProofBegin extends MyAbstractAsynchronousCustomFeature {
	 ...
	 *            The FeatureProvider
	 */
	public VerifyVariantWithoutInnerLoopsPartialProofBegin(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify the variant without inner loops (splitted) as partial proof (begin)";
	}
