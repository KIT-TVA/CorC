...
import de.tu_bs.cs.isf.cbc.tool.proofs.strategies.ProofGraphOriginalStatementBeginStrategy;
	...
	public void execute(ICustomContext context, IProgressMonitor monitor) {
		...
		if (pes != null && pes.length == 1) {
			...
			if (bo instanceof AbstractStatement statement) {
					...
					KeYProofProver prover = new KeYProofProver(keyProof, new ProofGraphOriginalStatementBeginStrategy());
