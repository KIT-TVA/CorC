		...
		if (bo instanceof CbCFormulaImpl) {
			...
			if (mc.getInheritsFrom() != null) {
				...
				if (pre != null && post != null) {
					inheritanceLabelText.setText("This method has a super-implementation in the class "
					...
					inheritanceLabelText.setText("This method has no super-implementation in the class "
							+ mc.getInheritsFrom().getName() + ".");
				}
				parent.pack();
