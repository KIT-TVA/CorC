 ...
 *
 */
public class RenameRenamingFeature extends AbstractCustomFeature {
     ...
     */
    public RenameRenamingFeature(IFeatureProvider fp) {
        super(fp);
    }
 
    @Override
    public String getName() {
        return "Edit Name of a Renaming Feature";
    }
 
    @Override
    public String getDescription() {
        return "Edit Name of a Renaimg Feature";
    }
