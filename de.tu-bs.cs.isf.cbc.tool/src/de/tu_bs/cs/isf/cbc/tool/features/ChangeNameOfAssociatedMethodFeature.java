 ...
 *
 */
public class ChangeNameOfAssociatedMethodFeature extends AbstractCustomFeature {
     ...
     */
    public ChangeNameOfAssociatedMethodFeature(IFeatureProvider fp) {
        super(fp);
    }
 
    @Override
    public String getName() {
        return "Edit Name of Associated Method";
    }
 
    @Override
    public String getDescription() {
        return "Edit the Name of the Associated Method";
    }
    ...
    public void execute(ICustomContext context) {
        ...
        if (pes != null && pes.length == 1) {
            ...
            if (bo instanceof CbCFormula) {
                ...
                String currentName = formula.getMethodName();
                // ask user for a new class name
                String newName = askString(getName(), getDescription(),
                        currentName);
                if (newName != null && !newName.equals(currentName)) {
            		this.hasDoneChanges = true;
                    formula.setMethodName(newName);
