 ...
 *
 */
public class IFbCSection extends GFPropertySection implements ITabbedPropertyConstants {
	...
	// TODO: support for other diagram types like composition -> intermediate
	// condition
	...
	if (pe != null) {
		...
		this.typeableText.setText(statement.getTypeableText() == null ? "" : statement.getTypeableText());
