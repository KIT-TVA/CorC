...
import de.tu_bs.cs.isf.cbc.tool.features.CreateLattice;
...
import de.tu_bs.cs.isf.cbc.tool.features.PrintConfidentialityMap;
...
import de.tu_bs.cs.isf.cbc.tool.patterns.IFbCSpecPattern;
import de.tu_bs.cs.isf.cbc.tool.patterns.MethodLinkPattern;
...
//        addPattern(new RepetitionPattern());
        ...
        addPattern(new MethodLinkPattern());
        addPattern(new IFbCSpecPattern());
        // Is invisible, needs to be the last element in the list/array
...
//	    		new VerifyVariant(this),
	    		...
	    		new CreateLattice(this),
	    		new PrintConfidentialityMap(this),
