...
public class VerifyPreRepetitionStatementProofGraphBegin extends MyAbstractAsynchronousCustomFeature {
	 ...
	 *            The FeatureProvider
	 */
	public VerifyPreRepetitionStatementProofGraphBegin(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public String getName() {
		return "Verify the precondition of repetition statement as proof graph (begin)";
	}
		...
		if (pes != null && pes.length == 1) {
			...
			if (bo instanceof SmallRepetitionStatement) {
				...
				for (int i = 0; i < variants.length; i++) {
					...
					proven = prove.proveCImpliesCWithKey(refinements, parent.getPreCondition(),
