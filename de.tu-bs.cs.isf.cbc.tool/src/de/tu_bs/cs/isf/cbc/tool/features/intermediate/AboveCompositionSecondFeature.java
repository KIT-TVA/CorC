 ...
 *
 */
public class AboveCompositionSecondFeature extends AbstractCustomFeature {
    
    /**
     * Constructor of the class
     * @param fp	The FeatureProvider
     */
    public AboveCompositionSecondFeature(IFeatureProvider fp) {
        super(fp);
    }
    
    @Override
    public String getName() {
        return "Composition statement above (second)";
    }
    ...
    public void execute(ICustomContext context) {
        ...
        if (pes != null && pes.length == 1) {
            ...
            if (bo instanceof AbstractStatement) {
            	...
            	Shape peNewParentStatement = (Shape) getFeatureProvider().getPictogramElementForBusinessObject(newParent.getSecondStatement());
