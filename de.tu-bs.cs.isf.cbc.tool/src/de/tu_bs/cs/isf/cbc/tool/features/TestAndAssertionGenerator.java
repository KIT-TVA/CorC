...
public class TestAndAssertionGenerator extends MyAbstractAsynchronousCustomFeature{
	...
	public void execute(ICustomContext context, IProgressMonitor monitor) {
		...
		if (formula.getMethodObj() == null) {
			Console.printWarn("TestAndAssertionGeneratorWarning: Method object is undefined. Assuming method is of type 'void'.");
	...
	private boolean test(final URI uri, final CbCFormula formula, final JavaVariables vars, final GlobalConditions globalConditions, final String signatureString, final List<String> globalVars, final Features features) throws ReferenceException, TestAndAssertionGeneratorException, PreConditionSolverException, UnexpectedTokenException, TestStatementException, DiagnosticsException, SettingsException, MalformedURLException, ClassNotFoundException {
		...
		if (inputs.isEmpty()) {
			Console.printWarn("TestAndAssertionGeneratorInfo: There are no controllable inputs for method " + methodToGenerate.getName() + ".");
	...
	private String genTestCases(final String className, final List<TestCaseData> inputs, final String postCondition, final GlobalConditions conds, final CbCFormula formula) throws TestStatementException, UnexpectedTokenException, SettingsException {
