...
//		refinedStatement.setProven(false);
		if (refinedStatement instanceof SkipStatement) {
			...
			for (int i = 0; i < childSel.getCommands().size(); i++) {
				...
				if (!childStatement.getPreCondition().getName().equals(preHighVars + "(" + preParent.getName() + ") & (" + childGuard.getName() + ")") || !childStatement.getPostCondition().getName().equals(postParent.getName())
						) {
					refinedStatement.setProven(false);
				}
				...
				childStatement.getPreCondition().setName(preHighVars + "(" + preParent.getName() + ") & (" + childGuard.getName() + ")");
