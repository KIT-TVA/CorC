...
public class RenameStatementFeature extends AbstractCustomFeature {
	...
	public boolean canExecute(ICustomContext context) {
		...
		if (pes != null && pes.length == 1) {
			...
			if (bo != null && bo.getClass().equals(AbstractStatementImpl.class) || bo instanceof ReturnStatement
					|| bo instanceof MethodStatement || bo instanceof StrengthWeakStatement
	...
	public void execute(ICustomContext context) {
		...
		if (pes != null && pes.length == 1) {
			Object bo = getBusinessObjectForPictogramElement(pes[0]);
			if (bo.getClass().equals(AbstractStatementImpl.class) || bo instanceof ReturnStatement
					|| bo instanceof MethodStatement || bo instanceof StrengthWeakStatement
					|| bo instanceof OriginalStatement) {
