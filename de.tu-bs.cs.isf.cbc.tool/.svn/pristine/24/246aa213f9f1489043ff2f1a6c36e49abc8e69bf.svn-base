...
//		refinedStatement.setProven(false);
		if (refinedStatement instanceof SkipStatement) {
			...
			if (!loopStatement.getPreCondition().getName().equals("(" + childRep.getInvariant().getName() + ") & (" + childRep.getGuard().getName() + ")") || !childRep.getPostCondition().getName().equals(postParent)
					) {
