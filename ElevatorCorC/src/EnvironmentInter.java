public interface EnvironmentInter{
	...
	@*/
	public /*@helper@*/ default void createEnvironment(int numFloors) {
		int index = 0;
		index = 0;
	...
	@ assignable this.floors[*];
	@*/
	public /*@helper@*/ default void EnvironmentInterC(int numFloors) {
		int index = 0;
		index = 0;
		this.floors = new Floor[numFloors];
		//@ loop_invariant index >= 0 && this.floors.length == numFloors &&(\forall int k;((k>0 && k<index && k<this.floors.length) ==> (this.floors[k].thisFloorID == k && this.floors[k].env == this )));
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Floor getFloorResult(int id) {
		Floor floor = null;
...
&& id >= 0)) {
	...
	@ assignable \nothing;
	@*/
	public /*@pure helper@*/ default Floor[] getFloors() {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean isTopFloor(int id) {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Floor getFloor(int id) {
