public interface ElevatorInter{
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean areDoorsOpen() {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean buttonForFloorIsPressed(int floorID) {
		boolean result = false;
	...
	@*/
	public /*@helper@*/ default void continueInDirection__wrappee__Base(int dir) {
...
//				statement
	...
	@*/
	public /*@helper@*/ default void enterElevator__wrappee__Base(Person p) {
	...
	@*/
	public /*@helper@*/ default void enterElevator(Person p) {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean existInLiftCallsInDirection(int d) {
		boolean result = false;
		int index = 0;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default int getCurrentDirection() {
		int result = 0;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default int getCurrentFloorID() {
		int result = 0;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default Environment getEnv() {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean isBlocked() {
		boolean result = false;
		result = this.blocked;
		return result;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean isEmpty() {
		boolean result = false;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean isExecutiveFloor(int floorID) {
		boolean result = false;
	...
	@ assignable this.env;
	@*/
	public /*@helper@*/ default boolean isExecutiveFloorCalling() {
		boolean result = false;
		int index = 0;
		Floor tmpFloor = null;
		index = 0;
...
//	}
	...
	@*/
	public /*@helper@*/ default boolean old_leaveElevator__wrappee__Base(Person p) {
		boolean result = false;
		result = false;
		this.old_contains = this.persons.contains(p);
		if (this.old_contains == true) {
	...
	@*/
	public /*@helper@*/ default boolean leaveElevator__wrappee__Weight(Person p) {
		boolean result = false;
		result = false;
		this.old_contains = this.persons.contains(p);
		if (this.old_contains == true) {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default void pressInLiftFloorButton(int floorID) {
	...
	@*/
	public /*@helper@*/ default void pressInLiftFloorButton__wrappee__Base(int floorID) {
	...
	@ assignable this.floorButtons[*];
	@*/
	public /*@helper@*/ default void resetFloorButton(int floorID) {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default int reverse() {
		int result = 0;
		result = this.currentHeading;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean stopRequestedAtCurrentFloor() {
		boolean result = false;
		result = false;
...
&& ((this.floorButtons[this.currentFloorID] == true) ==> \result == true);
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean stopRequestedAtCurrentFloor__wrappee__Base() {
		boolean result = false;
...
&& (this.isExecutiveFloorCalling() == false || this.isExecutiveFloor(this.currentFloorID) == true) ==> \result == this.stopRequestedAtCurrentFloor__wrappee__Base();
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean stopRequestedAtCurrentFloor__wrappee__ExecutiveFloor() {
		boolean result = false;
		result = false;
	...
	@*/
	public /*@helper@*/ default void ElevatorInterC(Environment envx, boolean verbosex, int floorx, boolean headingUpx) {
	...
	@*/
	public /*@helper@*/ default boolean leaveElevator(Person p) {
		boolean tmpResult = false;
		int index = 0;
		boolean result = false;
		this.old_contains = this.persons.contains(p);
	...
	@ assignable this.old_contains,this.persons.collectionSize,this.persons.elements[*];
	@*/
	public /*@helper@*/ default boolean leaveElevator__wrappee__Base(Person p) {
		boolean result = false;
		result = false;
		this.old_contains = this.persons.contains(p);
		if (this.old_contains == true) {
