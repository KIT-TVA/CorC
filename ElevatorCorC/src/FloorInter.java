public interface FloorInter{
	...
	@*/
	public /*@helper@*/ default void addWaitingPerson(Person person) {
		this.callElevator();
	...
	@*/
	public /*@helper@*/ default void callElevator() {
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default int getFloorID() {
		int floorid = 0;
	...
	@ assignable \nothing;
	@*/
	public /*@helper@*/ default boolean hasCall() {
	...
	@ assignable this.elevatorCall;
	@*/
	public /*@helper@*/ default void reset() {
	...
	@*/
	public /*@helper@*/ default void processWaitingPersons(Elevator e) {
		int index = 0;
	...
	@*/
	public /*@helper@*/ default void createFloor(Environment envx, int idx) {
	...
	@ assignable this.env,this.thisFloorID,this.waiting;
	@*/
	public /*@helper@*/ default void FloorInter(Environment envx, int idx) {
		this.thisFloorID = idx;
		this.env = envx;
		this.waiting = new ArrayList();
