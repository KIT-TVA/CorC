public class Environment{
	...
	@ assignable this.floors[*];
	@*/
	public /*@helper@*/ Environment(int numFloors) {
		int index = 0;
		index = 0;
		this.floors = new Floor[numFloors];
		//@ loop_invariant index >= 0 && this.floors.length == numFloors &&(\forall int k;((k>0 && k<index && k<this.floors.length) ==> (this.floors[k].thisFloorID == k && this.floors[k].env == this )));
...
//	/*@
//	@ normal_behavior
//	@ requires this.floors != null && 0 <= id && id < this.floors.length && this.floors[id] != null;
//	@ ensures ((this.floors != null && id < this.floors.length && id >= 0) ==> \result == this.floors[id])&& ((this.floors == null || id >= this.floors.length || id < 0) ==> \result == null);
//	@ assignable \nothing;
//	@*/
