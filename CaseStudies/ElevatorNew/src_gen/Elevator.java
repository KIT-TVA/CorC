public class Elevator {
    ...
    @ ensures this.persons.contains(p) == true && this.floorButtons[p.getDestination()] == true;
    @ assignable \nothing;
    @*/
	...
	@ normal_behavior
	@ requires p != null && this.persons != null && this.persons.elements != null;
	@ ensures this.old_contains == true ==> (\result == true && p.isDestinationReached() == true && this.persons.contains(p) == false) && this.old_contains == false ==> \result == false && this.old_contains == true ==> (this.weight == \old(this.weight) - p.getWeight());
	@ assignable \nothing;
	@*/
	...
	public void pressInLiftFloorButton(int floorID) {
		original_pressInLiftFloorButton(floorID);
	...
	@ normal_behavior
	@ requires this.currentFloorID >= 0;
	@ ensures (this.isExecutiveFloorCalling() == true && this.isExecutiveFloor(this.currentFloorID) == false) ==> \result == false&& (this.isExecutiveFloorCalling() == false || this.isExecutiveFloor(this.currentFloorID) == true) ==> \result == this.original_stopRequestedAtCurrentFloor();
	@ assignable \nothing;
	@*/
