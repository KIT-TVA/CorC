...
public class DotTest {
	...
	public static void main(String[] args) throws GraphParserException, FileNotFoundException {
		...
		Lattice lattice = LatticeBuilder.buildLatticeFromDot(new FileInputStream("resources/test.dg"));
		...
		System.out.println("");
		startTime = System.nanoTime();
		final Lattice lattice2 = LatticeBuilder.buildLatticeFromDotWithGEF(new File("resources/test.dg"));
		stopTime = System.nanoTime();
		System.out.println("Execution time: " + ((double) (stopTime - startTime) / 1_000_000_000));
		bottom = lattice2.getNodePerName("bottom");
		a2 = lattice2.getNodePerName("a2");
		a1 = lattice2.getNodePerName("a1");
		b2 = lattice2.getNodePerName("b2");
		b1 = lattice2.getNodePerName("b1");
		top = lattice2.getNodePerName("top");
