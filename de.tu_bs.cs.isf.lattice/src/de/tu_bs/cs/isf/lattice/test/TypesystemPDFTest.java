...
public class TypesystemPDFTest {
	public static void main(String[] args) {
		...
		System.out.println("P, PF, PB: " + LeastUpperBound.leastUpperBound(Arrays.asList(P, PF, PB), lattice).getName());
		...
		System.out.println("P, PF, PB: " + LeastUpperBound.leastUpperBound(Arrays.asList(P, PF, PB), lattice).getName());
		System.out.println("P, PF, PB, E: " + LeastUpperBound.leastUpperBound(Arrays.asList(P, PF, PB, E), lattice).getName());
	}
