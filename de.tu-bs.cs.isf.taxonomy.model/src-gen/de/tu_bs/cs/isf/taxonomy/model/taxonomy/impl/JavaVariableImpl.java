 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.taxonomy.model.taxonomy.impl.JavaVariableImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaVariableImpl extends MinimalEObjectImpl.Container implements JavaVariable {
	...
	protected EClass eStaticClass() {
		return TaxonomyPackage.Literals.JAVA_VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaxonomyPackage.JAVA_VARIABLE__NAME, oldName, name));
	}
