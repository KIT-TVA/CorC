...
public class DslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CodeStringElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cVariableStringParserRuleCall_3_0 = (RuleCall)cAlternatives_3.eContents().get(0);
		private final Group cGroup_3_1 = (Group)cAlternatives_3.eContents().get(1);
		private final Keyword cHyphenMinusKeyword_3_1_0 = (Keyword)cGroup_3_1.eContents().get(0);
		private final RuleCall cINTTerminalRuleCall_3_1_1 = (RuleCall)cGroup_3_1.eContents().get(1);
		private final Group cGroup_4 = (Group)cGroup.eContents().get(4);
		private final RuleCall cOperationParserRuleCall_4_0 = (RuleCall)cGroup_4.eContents().get(0);
		private final Alternatives cAlternatives_4_1 = (Alternatives)cGroup_4.eContents().get(1);
		private final RuleCall cVariableStringParserRuleCall_4_1_0 = (RuleCall)cAlternatives_4_1.eContents().get(0);
		private final Group cGroup_4_1_1 = (Group)cAlternatives_4_1.eContents().get(1);
		private final Keyword cHyphenMinusKeyword_4_1_1_0 = (Keyword)cGroup_4_1_1.eContents().get(0);
		private final RuleCall cINTTerminalRuleCall_4_1_1_1 = (RuleCall)cGroup_4_1_1.eContents().get(1);
		...
		//VariableString
		public RuleCall getVariableStringParserRuleCall_3_0() { return cVariableStringParserRuleCall_3_0; }
		...
		//Operation
		public RuleCall getOperationParserRuleCall_4_0() { return cOperationParserRuleCall_4_0; }
		
		//(VariableString | '-'? INT)
		public Alternatives getAlternatives_4_1() { return cAlternatives_4_1; }
		
		//VariableString
		public RuleCall getVariableStringParserRuleCall_4_1_0() { return cVariableStringParserRuleCall_4_1_0; }
		
		//'-'? INT
		public Group getGroup_4_1_1() { return cGroup_4_1_1; }
		
		//'-'?
		public Keyword getHyphenMinusKeyword_4_1_1_0() { return cHyphenMinusKeyword_4_1_1_0; }
		
		//INT
		public RuleCall getINTTerminalRuleCall_4_1_1_1() { return cINTTerminalRuleCall_4_1_1_1; }
