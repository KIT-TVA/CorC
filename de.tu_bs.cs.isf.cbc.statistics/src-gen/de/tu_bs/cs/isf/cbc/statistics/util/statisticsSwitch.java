...
public class statisticsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case statisticsPackage.STATISTICS_REGISTRY: {
				StatisticsRegistry statisticsRegistry = (StatisticsRegistry)theEObject;
				T result = caseStatisticsRegistry(statisticsRegistry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case statisticsPackage.STATISTICS_ENTRY: {
				StatisticsEntry statisticsEntry = (StatisticsEntry)theEObject;
				T result = caseStatisticsEntry(statisticsEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Statistics Registry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Statistics Registry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStatisticsRegistry(StatisticsRegistry object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Statistics Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Statistics Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStatisticsEntry(StatisticsEntry object) {
		return null;
	}
