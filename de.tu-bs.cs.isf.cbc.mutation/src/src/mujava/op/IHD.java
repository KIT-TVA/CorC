...
/**
 * <p>
 * Generate IHD (Hiding variable deletion) mutants -- delete each declaration of
 * an overriding, or hiding variable to causes references to that variable to
 * access the variable defined in the parent.
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class IHD extends DeclAnalyzer {
	 ...
	 * <i> When to generate</i>: if declared fields have the same name and type with
	...
	public IHD(openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1,
