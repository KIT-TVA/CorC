...
public class AMC extends src.mujava.op.util.Mutator {
	...
	/**
	 * Generate AMC mutants by altering the access level for each instance variable
	 * and method to other access levels (PRIVATE, PROTECTED, PUBLIC, PACKAGE or
	 * default)
	 * 
	 * @param mod
	 */
