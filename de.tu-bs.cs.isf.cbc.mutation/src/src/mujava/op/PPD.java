...
/**
 * <p>
 * Generate PPD (Parameter variable declaration with child class type) mutants
 * -- change the declared type of a parameter object reference to be that of the
 * parent of its original declared type.
 * </p>
 * <p>
 * <i>Note</i>: The PPD operator is the same as the PMD, except that it operates
 * on parameters rather than instance and local variables.
 * </p>
 * <p>
 * <i>Example</i>: let class A be the parent of class B -- boolean equals(B o)
 * {...} is mutated to boolean equals (A o) {...}
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class PPD extends src.mujava.op.util.PolymorphicMutator {
