...
/**
 * <p>
 * Generate PCI (Type cast operator insertion) mutants -- change the actual type
 * of an object reference to the parent or child of the original declared type
 * </p>
 * <p>
 * <i>Example</i>: <br/>
...
public class PCI extends src.mujava.op.util.TypeCastMutator {
