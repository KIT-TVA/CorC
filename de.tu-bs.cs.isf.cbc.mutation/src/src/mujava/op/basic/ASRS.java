...
public class ASRS extends MethodLevelMutator {
	 ...
	 * replace it with each of the other arithmetic assignment operators. If the
	 * assignment operator is of logical type (&=, |=, ^=), replace it with each of
	 * the other logical assignment operators. If the assignment operator is a shift
	 * operator (<<, >>, >>>) replace it with each of the other shift operators.
	 */
	public void visit(AssignmentExpression p) throws ParseTreeException {
		int op = p.getOperator();
		if ((op == AssignmentExpression.ADD) || (op == AssignmentExpression.SUB) || (op == AssignmentExpression.MULT)
				|| (op == AssignmentExpression.DIVIDE) || (op == AssignmentExpression.MOD)) {
	...
	/*
	 * Replace the arithmetic assignment operator (+=, -+, *=, /=, %=) by each of
	 * the other operators
	 */
	...
	/*
	 * Replace the logical assignment operator (&=, |+, ^=) by each of the other
	 * operators
	 */
	...
	/*
	 * Replace the shift assignment operator (<<=, >>=, >>>=) by each of the other
	 * operators
	 */
