 ...
 * @version 1.0
 */
public class MethodLevelMutator extends src.mujava.op.util.Mutator {
	...
	String getMethodSignature(MethodDeclaration p) {
		...
		// the for loop goes through each parameter of a method and return them in a
		// String, separated by comma
		for (int i = 0; i < pars.size(); i++) {
			// because generics in introduced, the original code does not work anymore
			// the code below applies the cheapest solution: ignore generics by removing the
	...
	String getConstructorSignature(ConstructorDeclaration p) {
		...
		// the for loop goes through each parameter of a constructor and return them in
	 ...
	 */
	public String getSourceName(src.mujava.op.util.Mutator clazz) {
