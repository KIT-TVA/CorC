...
/**
 * <p>
 * Generate PMD (Member variable declaration with parent class type) mutants ---
 * change the declared type of an object reference to the parent of the original
 * declared type
 * </p>
 * <p>
 * <i>Example</i>: let class A be the parent of class B -- B b; b = new B(); is
 * mutated to A b; b = new B();
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class PMD extends src.mujava.op.util.PolymorphicMutator {
