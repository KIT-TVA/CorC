...
/**
 * <p>
 * Generate OMR (Overloading method contents replace) mutants -- replaces the
 * body of a method with the body of another method that has the same name
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class OMR extends DeclAnalyzer {
	 ...
	 * @param mutant
	 */
	public void outputToFile(CompilationUnit comp_unit, MethodDeclaration original, String mutant) {
		if (comp_unit == null)
			return;
	...
	public OMR(openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1,
