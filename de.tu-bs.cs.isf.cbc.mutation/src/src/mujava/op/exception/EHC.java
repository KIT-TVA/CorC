...
public class EHC extends src.mujava.op.util.Mutator {
	public EHC(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit) {
	...
	public void generateEHC(CatchBlock p, String e_name) {
		InheritanceINFO inf = src.mujava.MutationSystem.getInheritanceInfo(e_name);
		if (inf == null)
			return;
