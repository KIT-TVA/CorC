 ...
 */
/**
 * Changed the getPrintWriter to create subdirs if they don't exist, the original version would just stop working at this point.
 */
...
public class Mutator extends src.mujava.openjava.extension.VariableBinder {
	public int num = 0;
