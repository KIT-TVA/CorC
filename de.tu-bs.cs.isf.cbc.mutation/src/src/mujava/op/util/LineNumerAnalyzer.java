...
public class LineNumerAnalyzer extends ParseTreeVisitor {
	...
	protected final void writeListWithDelimiterNewline(List list) throws ParseTreeException {
	...
	protected final void writeListWithSuffixNewline(List list) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected final void writeArguments(ExpressionList args) throws ParseTreeException {

	}

	protected final void writeAnonymous(Object obj) throws ParseTreeException {
		if (obj == null) {
	...
	protected final void writeList(List list) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected final void writeListWithDelimiter(List list, String delimiter) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected final void writeListWithSuffix(List list, String suffix) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected final void writeParenthesis(Expression expr) throws ParseTreeException {
		expr.accept(this);
	}

	protected final void writeStatementsBlock(StatementList stmts) throws ParseTreeException {
		line_num++;
