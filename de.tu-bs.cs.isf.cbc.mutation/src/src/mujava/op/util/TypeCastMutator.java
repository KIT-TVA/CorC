...
/**
 * <p>
 * Mutant Generator for the mutation operators that are related with
 * polymorphism
 * </p>
 * 
 * @author Yu-Seung Ma
...
public class TypeCastMutator extends PolymorphicMutator {
	...
	protected boolean isNonAbstractOverridingMethodCall(String childClass, String parentClass, String method_name,
			Class[] pars) {
		try {
			Class child_class = Class.forName(childClass);
			Class parent_class = Class.forName(parentClass);
