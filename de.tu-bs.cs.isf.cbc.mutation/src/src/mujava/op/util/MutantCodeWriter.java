 ...
 */
/**
 * Worked on this file as allowed by the license.
 * The Code was enhanced to support comments in mutants.
 */
...
public class MutantCodeWriter extends ParseTreeVisitor {
	...
	public void visit(Leaf p) throws ParseTreeException {
		System.err.println("Leaf txt: " + p.toString());
	}
	...
	public void visit(ClassDeclaration p) throws ParseTreeException {
		...
		if (p.getComment() != null) {
			String[] commentlines = p.getComment().split(System.lineSeparator());
	...
	public void visit(AllocationExpression p) throws ParseTreeException {
		...
		System.err.println(p.getComment());
