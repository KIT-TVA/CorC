...
public class ScopeHandlingMutantCodeWriter extends MutantCodeWriter {
	...
	/* compilation unit */
	public void evaluateDown(CompilationUnit ptree) throws ParseTreeException {
	...
	/* class declaration */
	public void evaluateDown(ClassDeclaration ptree) throws ParseTreeException {
		/* records this class */
	...
	protected OJClass computeRefType(TypeName typename, Expression expr) throws ParseTreeException {
		if (typename != null)
	...
	protected static void bindLocalVariable(VariableDeclaration var_decl, Environment env) {
