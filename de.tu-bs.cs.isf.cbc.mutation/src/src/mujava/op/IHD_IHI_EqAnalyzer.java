...
/**
 * <p>
 * Description: Examine if insertion or deletion of a certain field change
 * semantic of a class
 * </p>
 * <b> Principle </b> : If <i> field_name </i> is used anywhere in a class,
 * there is high possibility of non-equivalent <br>
 * In contrast, <i> field_name </i> not used any and is not declared with public
 * access level, it is an equivalent mutant.
 * 
 * @author Yu-Seung Ma
 * @version 1.0
 */

public class IHD_IHI_EqAnalyzer extends src.mujava.op.util.Mutator {
	...
	/**
	 * Return if an insertion or deletion of <i> field_name</i> field makes
	 * equivalent mutant
	 */
	...
	/**
	 * If parameter use the same name with a field, the field is hidden within a
	 * method or a constructor where the parameter is used.
	 */
