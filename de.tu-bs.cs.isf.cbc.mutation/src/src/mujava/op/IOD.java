...
/**
 * <p>
 * Generate IOD (Overriding method deletion) mutants -- delete an entire
 * declaration of an overriding method in a subclass so that references to the
 * method uses the parent's version.
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class IOD extends DeclAnalyzer {
	...
	public IOD(openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1,
