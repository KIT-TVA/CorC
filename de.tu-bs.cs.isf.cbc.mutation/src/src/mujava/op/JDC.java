...
/**
 * <p>
 * Generate JDC (Java-supported default constructor creation) -- delete each
 * declaration of default constructor (with no parameter)
 * </p>
 * 
 * @author Yu-Seung Ma
 * @update by Nan Li May 2012 fix a bug of JDC
 * @The bug is: when a constructor is deleted, the mutanted program shows //
 *      JDC_1(){...}; it supposes to show //class_name(){...}
 * @in other words, the mutanted progam shows the name of the mutant (JDC_1)
 *     instead of the name of the constructor (like VendingMachine)
 * @version 1.0
 */
...
public class JDC extends DeclAnalyzer {
	...
	public JDC(openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1,
