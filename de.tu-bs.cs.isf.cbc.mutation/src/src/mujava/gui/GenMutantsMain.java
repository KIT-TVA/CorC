...
public class GenMutantsMain extends JFrame {
	 ...
	 * selection of mutation operators to apply
	 * </p>
	 * 
	 * @throws Exception
	 */
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			System.err.println(
					"[ERROR] Could not find one of the classes necessary to run muJava. Make sure that the .jar file for openjava is in your classpath.");
			System.err.println();
			e.printStackTrace();
			return;
		}
		...
		try {
			...
			System.err.println(
					"[ERROR] An error occurred while initializing muJava. This may have happened because the files used by muJava are in an unexpected state. Try deleting any uncompiled mutants that were generated in the result/ directory, and then re-generate them.");
			System.err.println();
			e.printStackTrace();
			return;
		}
