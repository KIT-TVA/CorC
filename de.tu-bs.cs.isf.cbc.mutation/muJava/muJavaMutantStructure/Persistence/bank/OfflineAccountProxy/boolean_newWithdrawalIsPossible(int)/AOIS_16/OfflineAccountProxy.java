 ...
 * again
 */
public class OfflineAccountProxy extends bank.Account
{

    public static final int sessionLimit = 1000;

//@ private invariant offlineBalance >=0 && offlineBalance <= 1000;
    public int offlineBalance = sessionLimit;
...
/**
     ...
     */
    public  void replay( bank.PermanentAccount target )
    {
...
/**
     ...
     */
    private  void replay( bank.PermanentAccount target, TransactionList transes )
    {
        if (transes.isEmpty()) {
            return;
        }
