...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.taxonomy.model.taxonomy.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TaxonomyPackage.Literals.METHOD__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPseudoCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_pseudoCode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_pseudoCode_feature", "_UI_Method_type"),
				 TaxonomyPackage.Literals.METHOD__PSEUDO_CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPreConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_preCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_preCondition_feature", "_UI_Method_type"),
				 TaxonomyPackage.Literals.METHOD__PRE_CONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPostConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_postCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_postCondition_feature", "_UI_Method_type"),
				 TaxonomyPackage.Literals.METHOD__POST_CONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaxonomyPackage.Literals.METHOD__DATA_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TaxonomyPackage.Literals.METHOD__DATA_TYPES,
