...
public class LOSTParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'}'", "'()'", "'R:'", "'guard:'", "'C('", "'B('", "'O:'", "'('", "'pre:'", 
		"','", "'Vars'", "'M:'", "'inv:'", "'\t'", "'S('", "'L('", "'skip'", "'name:'", 
		"'F'", "'GlobalConditions'", "')'", "WS", "'\n'", "OP", "ID"
	};
	public static final int
		RULE_program = 0, RULE_initializer = 1, RULE_vars = 2, RULE_variable = 3, 
		RULE_globalConditions = 4, RULE_renaming = 5, RULE_renamer = 6, RULE_formula = 7, 
		RULE_pre = 8, RULE_post = 9, RULE_intm = 10, RULE_condition = 11, RULE_quantor = 12, 
		RULE_refinement = 13, RULE_refinementRule = 14, RULE_statement = 15, RULE_javaReturn = 16, 
		RULE_assigner = 17, RULE_composition = 18, RULE_selection = 19, RULE_guards = 20, 
		RULE_repetition = 21, RULE_inv = 22, RULE_guard = 23, RULE_var = 24, RULE_returnS = 25, 
		RULE_originalS = 26, RULE_skipS = 27, RULE_methodCallS = 28, RULE_block = 29, 
		RULE_name = 30, RULE_mlexpr = 31;
	public static final String[] ruleNames = {
		"program", "initializer", "vars", "variable", "globalConditions", "renaming", 
		"renamer", "formula", "pre", "post", "intm", "condition", "quantor", "refinement", 
		"refinementRule", "statement", "javaReturn", "assigner", "composition", 
		"selection", "guards", "repetition", "inv", "guard", "var", "returnS", 
		"originalS", "skipS", "methodCallS", "block", "name", "mlexpr"
	};
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(64); initializer();
				}
				}
				setState(67); 
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__21) | (1L << T__10) | (1L << T__2) | (1L << T__1) | (1L << NL))) != 0) );
	...
	public final FormulaContext formula() throws RecognitionException {
		...
		try {
			...
			setState(169); match(NL);
			setState(170); refinement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PreContext pre() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(172); match(T__12);
			setState(173); condition();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConditionContext condition() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				setState(194); condition();
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(195); match(OP);
	...
	public final RefinementRuleContext refinementRule() throws RecognitionException {
		...
		try {
			...
			case T__16:
				enterOuterAlt(_localctx, 2);
				{
				setState(215); composition();
				}
				break;
			case T__6:
				enterOuterAlt(_localctx, 3);
				{
				setState(216); selection();
				}
				break;
			case T__5:
				enterOuterAlt(_localctx, 4);
				{
				setState(217); repetition();
				}
				break;
			case T__18:
				enterOuterAlt(_localctx, 5);
				{
				setState(218); returnS();
				}
				break;
			case T__14:
				enterOuterAlt(_localctx, 6);
				{
				setState(219); originalS();
				}
				break;
			case T__4:
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				setState(237); match(OP);
				setState(238); assigner();
				}
				break;
			}
	...
	public final AssignerContext assigner() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				setState(256); assigner();
				}
				break;
			case 5:
				{
				setState(257); match(ID);
				setState(258); match(OP);
				setState(259); assigner();
				}
				break;
			}
			}
	...
	public final CompositionContext composition() throws RecognitionException {
		...
		try {
			...
			setState(266); refinement();
			setState(267); refinement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
