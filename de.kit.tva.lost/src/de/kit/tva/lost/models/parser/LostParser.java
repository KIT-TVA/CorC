...
public class LostParser extends Parser {
	...
	public static final String[] tokenNames = {"<INVALID>", "'return'", "'post:'", "'intm:'", "'var:'", "'{'", "'void'",
			"'\\'", "'Renaming'", "'}'", "'C'", "'R:'", "'guard:'", "'mod:'", "'O:'", "'('", "'sig:'", "'pre:'", "','",
			"'Vars'", "'M:'", "'inv:'", "'S'", "'\t'", "'['", "'skip'", "']'", "'bool'", "'[*]'", "'name:'", "'B'",
			"'D'", "'F'", "'GlobalConditions'", "')'", "'L'", "WS", "'\n'", "';'", "KIND", "VISIBILITY", "TYPE",
			"BRACKETS", "'()'", "'new '", "OP", "QT", "ID"};
