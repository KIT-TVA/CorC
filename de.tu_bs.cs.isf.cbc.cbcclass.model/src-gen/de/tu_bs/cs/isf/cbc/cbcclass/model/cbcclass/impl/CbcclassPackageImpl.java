...
public class CbcclassPackageImpl extends EPackageImpl implements CbcclassPackage {
	 ...
	 * @see de.tu_bs.cs.isf.cbc.cbcclass.model.cbcclass.CbcclassPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static CbcclassPackage init() {
		if (isInited)
			return (CbcclassPackage) EPackage.Registry.INSTANCE.getEPackage(CbcclassPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCbcclassPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CbcclassPackageImpl theCbcclassPackage = registeredCbcclassPackage instanceof CbcclassPackageImpl
				? (CbcclassPackageImpl) registeredCbcclassPackage
				: new CbcclassPackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(CbcmodelPackage.eNS_URI);
		CbcmodelPackageImpl theCbcmodelPackage = (CbcmodelPackageImpl) (registeredPackage instanceof CbcmodelPackageImpl
				? registeredPackage
				: CbcmodelPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		CbcmodelPackage theCbcmodelPackage = (CbcmodelPackage) EPackage.Registry.INSTANCE
				.getEPackage(CbcmodelPackage.eNS_URI);
		...
		initEClass(modelClassEClass, ModelClass.class, "ModelClass", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getModelClass_Name(), ecorePackage.getEString(), "name", null, 0, 1, ModelClass.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelClass_JavaClassURI(), ecorePackage.getEString(), "javaClassURI", null, 0, 1,
				ModelClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getModelClass_Fields(), this.getField(), null, "fields", null, 0, -1, ModelClass.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModelClass_Methods(), this.getMethod(), this.getMethod_ParentClass(), "methods", null, 0, -1,
		...
		initEAttribute(getField_Name(), ecorePackage.getEString(), "name", null, 0, 1, Field.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getField_IsStatic(), ecorePackage.getEBoolean(), "isStatic", null, 0, 1, Field.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getField_IsFinal(), ecorePackage.getEBoolean(), "isFinal", null, 0, 1, Field.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getField_DisplayedName(), ecorePackage.getEString(), "displayedName", null, 0, 1, Field.class,
				IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethod_CbcStartTriple(), theCbcmodelPackage.getCbCFormula(),
				theCbcmodelPackage.getCbCFormula_MethodObj(), "cbcStartTriple", null, 0, 1, Method.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMethod_ParentClass(), this.getModelClass(), this.getModelClass_Methods(), "parentClass", null,
				0, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethod_Precondition(), theCbcmodelPackage.getCondition(), null, "precondition", null, 0, 1,
